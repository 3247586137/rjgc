...
# text 待合成文本，不超过500字, sex 0女1男
# path 保存路径，默认D:/test.wav
def ttsc_example(text = "你好，好久不见", sex = 0, path = "D:/test.wav"):
    """ 语音合成demo """
    ak = 'HPUAK4GXNUMTX3Y66JXP'             # 参考https://support.huaweicloud.com/sdkreference-sis/sis_05_0003.html
    sk = 'rTDf28OU0dCgbflsuxkZ91Uk8crNKLjWZQg56zHB'             # 参考https://support.huaweicloud.com/sdkreference-sis/sis_05_0003.html
    region = 'cn-north-4'         # region，如cn-north-4
    project_id = '8a42098dfac64da5b1762138b9ae5f70'     # 同region一一对应，参考https://support.huaweicloud.com/api-sis/sis_03_0008.html
    ...
    if sex == 0:
        ttsc_request.set_property('chinese_huaxiaowei_common')
    else:
        ttsc_request.set_property('chinese_huaxiaogang_common')
